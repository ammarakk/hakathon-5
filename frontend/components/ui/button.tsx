...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      default:
        "bg-gradient-to-r from-pink-500 to-purple-600 text-white hover:shadow-lg hover:scale-105 focus:ring-pink-500",
      outline:
        "border-2 border-pink-500 text-pink-600 hover:bg-pink-50 focus:ring-pink-500",
